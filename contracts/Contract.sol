...
contract MyContract {
    ...
    function removestaff(address staff) public {
        ...
        uint256 removal_id;
        for (uint256 i = 0; i < staffregistry.length; i++) {
    ...
    function createRecord(string memory name, string memory surname, string memory dob) public returns(uint256 id) {
        ...
        records.push(record(name, surname, dob, '0', msg.sender, new address[](0)));
        return newrecordid;
    }
